...
int reminder(Dlist **dividend_head, Dlist **dividend_tail,
             ...
             Dlist **quot_head, Dlist **quot_tail)
{
    ...
    deletelist(quot_head, quot_tail);

    //remove_leading_zeros(&partial_head, &partial_tail); // cleanup
    *quot_head=partial_head;
    *quot_tail=partial_tail;
